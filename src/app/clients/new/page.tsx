      ...
      <div className="max-w-[1200px] mx-auto space-y-8 p-4 sm:p-0 animate-in fade-in duration-700">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
          <div className="space-y-1">
            <h1 className="text-4xl font-black tracking-tight text-slate-900">Nouveau Client</h1>
            <p className="text-slate-500 font-medium text-sm">Ajouter une nouvelle fiche client au répertoire</p>
          </div>
          <button
            onClick={() => router.back()}
